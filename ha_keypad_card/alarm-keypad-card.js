...
class AlarmKeypadCard extends LitElement {
 ...
 updated(changedProperties) {
  ...
  setConfig(config) {
      ...
      this._buttonfocuscolor=(config.button_focus_color != null)?config.button_focus_color:"var(--secondary-background-color)" ;  
...
static get styles() {
    return css`
      ...
      :host {
           ...
           --buttonbg: var(--input-disabled-fill-color);
           --buttontext: var(--primary-text-color);
           --sensorlabel: var(--primary-text-color);
           --sensoroff: var(--disabled-text-color);
           --buttonhover: var(--secondary-background-color);
           --buttonactive: var(secondary-text-color);
           --buttonfocus: var(--secondary-background-color);
